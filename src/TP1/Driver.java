...
public class Driver {
     ...
     *
     * @param customerInformation list of either information pertaining to the creation of the node (index, hasRecharge; size = 2)
    ...
    private void initialiseDriver(List<String> customerInformation, int lineNumber) {
        ...
        if (infoLine.length == 1) {
            ...
            int index = Integer.parseInt(infoLine[0]);
            WeightedGraph.Node sourceNode = nodes.get(Integer.parseInt(infoLine[1]));
            WeightedGraph.Node destinationNode = nodes.get(Integer.parseInt(infoLine[2]));
            int minutesWeight = Integer.parseInt(infoLine[3]);
    ...
    public void nextAction() {
        ...
        while(!customersOnBoard.isEmpty() &&
                firstCust.destination.getIndex() == position.getIndex()){//if destination
            dropOff();
        ...
        for(int i = 1 ; i < j ; i++){
            ...
            if(testBattery.compareTo(destinationPath.getLast().getDistance()) < 15){
